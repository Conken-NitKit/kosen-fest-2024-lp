...
import { type ElementType, type HTMLAttributes, useEffect } from "react";
 ...
 * @param props.tag - このコンポーネントのタグを変更したいときに設定
 */
export const TypingAnimationText = ({
  ...
  return (
    <Component className={cn(font.display, "font-bold", className)} {...props}>
      {renderWords()}
      {/* カーソル(キャレット) */}
      <motion.span
        initial={{
